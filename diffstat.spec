...
%description -l de
'diffstat' stellt eine Reihe von statistischen Informationen für mit  Patch
erzeugte Diffs bereit, u.a. die Zahl der Einfügungen, der Streichungen
...
modifications. Il peut être utile, par exemple, de retrouver les
modifications faites à un programme en fournissant uniquement le patch de
mise à jour à diffstat.

%description -l pl
Diffstat umo¿liwia prowadzenie statystyk pliku (³atki) generowanego  przez
diff. Pakiet ten mo¿e byæ u¿yteczny, na przyk³ad w poszukiwaniu  zmian,
które zosta³y dokonane w jakim¶ programie.
